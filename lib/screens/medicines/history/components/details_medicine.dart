...
class DetailsMedicineMedicine {
  final detailsContent = WidgetLabelAndContent();
  MedicineDto medicine;

  DetailsMedicineMedicine({required this.medicine});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            detailsContent.widget(
                                ...
                                content: medicine.ingredientsActiveAnvisa.map((e) => e).join(', '),
                                isNotTextOverflowEllipsis: true),
                            detailsContent.widget(
                                label: 'Principais ativos',
                                content: medicine.principlesActives.map((e) => e.name).join(', '),
                                isNotTextOverflowEllipsis: true),
                          ],
                        ),
                      ),
